# TURUNDUS – UrbanStyle.ltd Portfoolio

## Meeskonnaliikmed ja rollid

| Nimi | Nädal 0 roll | Operatsioonisüsteem |
|---|---|---|
| Marianne Sisask | A: GitHub Repo Seadistaja | Mac |
| Kerty Kaljumäe | B: Supabase Seadistaja | Windows |
| Katariina Raid | C: NotebookLM Seadistaja | Windows |
| Hannes Saarmets | D: Team Charter Koostaja | Mac |

## Põhisüsteemid

### GitHub

[urbanstyle-turundus](https://github.com/mariannesisask-afk/urbanstyle-turundus)

Meeskonna ühine GitHubi repo, kus hoiame projekti faile ja dokumentatsiooni.
